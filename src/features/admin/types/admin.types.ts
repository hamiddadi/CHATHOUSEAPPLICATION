...
export interface AdminReport {
  ...
  contentAuthor: AdminUserRef | null;
  targetKind: 'USER' | 'ROOM' | 'DIRECT_MESSAGE' | 'GROUP_MESSAGE' | 'ROOM_MESSAGE';
  reportedMessageId: string | null;
  reportedGroupMessageId: string | null;
  reportedRoomMessageId: string | null;
  contentSnapshot: string | null;
  contentAudioUrl: string | null;
  contentAudioDurationMs: number | null;
  contentKind: 'TEXT' | 'VOICE' | null;
